  ...
  return (
    <div className="max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className="grid grid-cols-2 grid-rows-6 h-[80vh]">
        <img
          className="row-span-3 object-cover w-full h-full p-2 hover:scale-150 hover:rounded-3xl hover:ml-[25px]"
        ...
        />
        <img
          className="row-span-2 object-cover w-full h-full p-2 hover:scale-150 hover:rounded-3xl"
        ...
        />
        <img
          className="row-span-3 object-cover w-full h-full p-2 hover:scale-150 hover:rounded-3xl"
